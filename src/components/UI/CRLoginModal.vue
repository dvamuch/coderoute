...
const closeLoginAndRegistrationModal = authorizationStore.closeLoginAndRegistrationModal;
...
<template>
  <div class="crModalWrap scrollHide">
    ...
    <div class="crModalWindow" v-click-out="closeLoginAndRegistrationModal">
        ...
        <form class="flexibleY gapSmall">
          ...
          <div class="flexibleY gapSmaller">
            ...
            <div class="flexible gapSmallest">
              ...
              <button class="crFormItem button primary filled hLarge radRound grow">Войти в CodeRoute</button>
            </div>
          </div>
      ...
      <div class="crModalClose modalToggle" title="Закрыть" @click="closeLoginAndRegistrationModal">
